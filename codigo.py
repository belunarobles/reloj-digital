...
def obtener_tiempo():
    ...
    texto_hora.config(text=hora, font = ('Futura BdCn BT', t))
...
texto_hora = Label(ventana, fg = 'white', bg = 'gray10')
texto_hora.grid(row = 0, sticky = 'nsew', ipadx = 5, ipady = 20)

texto_dia = Label(ventana, fg = 'white', bg = 'gray30', font = ('Futura Md BT',20))
texto_dia.grid(row = 1, sticky= "nsew")

texto_fecha = Label(ventana, fg = 'white', bg = 'gray50', font = ('Futura Bk BT',20))
